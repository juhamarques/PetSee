          ...
          <form id="filter-form">
            ...
            <div class="filter-group mb-4">
              ...
              <div class="radio-group" id="type-group">
                <p><input type="checkbox" name="type" value="cachorro"><span>Cachorro</span></p>
                <p><input type="checkbox" name="type" value="gato"><span>Gato</span></p>
                <p><input type="checkbox" name="type" value="passaro"><span>Pássaro</span></p>
                <p><input type="checkbox" name="type" value="roedor"><span>Roedor</span></p>
              </div>
            </div>
            ...
            <div class="filter-group mb-4">
              ...
              <div class="radio-group" id="sex-group">
                <p><input type="checkbox" name="sex" value="macho"><span>Macho</span></p>
                <p><input type="checkbox" name="sex" value="femea"><span>Fêmea</span></p>
              </div>
            </div>
            ...
            <div class="filter-group mb-4">
              ...
              <div class="radio-group" id="status-group">
                <p><input type="checkbox" name="status" value="perdido"><span>Perdido</span></p>
                <p><input type="checkbox" name="status" value="resgatado"><span>Resgatado</span></p>
                <p><input type="checkbox" name="status" value="adocao"><span>Para Adoção</span></p>
                <p><input type="checkbox" name="status" value="encontrado"><span>Encontrado</span></p>
              </div>
            </div>
